...
### Run code
${scp_cmd} ${workdir}/{gift_template.hwd2.txt,withdraw_template.hwd2.txt} root@${ip}:/root
...
mv -v \$lima/build/BACKSERVER/withdraw_template.hwd2.txt \$lima/build/BACKSERVER/withdraw_template.hwd2.txt_\$(date +%Y%m%d)
mv -v \$root/withdraw_template.hwd2.txt \$root/gift_template.hwd2.txt \$lima/build/BACKSERVER/
elif [ -d \$sftw ] ; then
mv -v \$sftw/build/BACKSERVER/gift_template.hwd2.txt \$sftw/build/BACKSERVER/gift_template.hwd2.txt_\$(date +%Y%m%d)
mv -v \$sftw/build/BACKSERVER/withdraw_template.hwd2.txt \$sftw/build/BACKSERVER/withdraw_template.hwd2.txt_\$(date +%Y%m%d)
mv -v \$root/withdraw_template.hwd2.txt \$root/gift_template.hwd2.txt \$sftw/build/BACKSERVER/
else
